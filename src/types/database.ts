...
export interface Anime { id: string; franchise_id: string | null; franchise?: { name: string }[] | null; title: string; season_number: number | null; season_label: string | null; title_japanese: string | null; title_english: string | null; synopsis: string | null; cover_path: string | null }
